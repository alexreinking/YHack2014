...
public interface CommandVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link CommandParser#specificCommand}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSpecificCommand(@NotNull CommandParser.SpecificCommandContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link CommandParser#longName}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLongName(@NotNull CommandParser.LongNameContext ctx);
}